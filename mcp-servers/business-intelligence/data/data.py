...
def get_all_crypto_data(start_date: str = "2020-01-01", end_date: str = None) -> Dict[str, pd.DataFrame]:
    """
    Fetch data for all available cryptocurrencies.
    """
    fetcher = CryptoDataFetcher()
    ...
    # Popular crypto symbols to try if Alpaca fails
    popular_cryptos = [
        'BTC', 'ETH', 'ADA', 'DOT', 'LINK', 'LTC', 'BCH', 'XLM', 
        'DOGE', 'MATIC', 'AVAX', 'ATOM', 'ALGO', 'SOL', 'UNI'
    ]
    ...
    if assets:
        ...
        all_symbols.extend(alpaca_symbols[:20])  # Limit to first 20 for testing
...
if __name__ == "__main__":
    ...
    btc_data = fetch_market_data("BTC", "2023-01-01", source='auto')
    ...
    crypto_datasets = get_all_crypto_data("2023-01-01")
