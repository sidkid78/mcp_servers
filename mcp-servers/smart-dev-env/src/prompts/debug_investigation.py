...
async def _analyze_issue(issue_description: str, error_logs: str) -> Dict:
    ...
    analysis = {
        "title": issue_description.split('.')[0][:50] if issue_description else "Unknown Issue",
        "summary": "",
        "category": "unknown",
        "severity": "medium",
        "error_patterns": []
    ...
    analysis["summary"] = f"{analysis['category'].title()} issue with {analysis['severity']} severity"
